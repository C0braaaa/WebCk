...
<head>
	...
	<script type="module" src="loginfb.js"></script>
                    ...
                    <div class="card-body p-5 text-center">
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <div class="d-flex justify-content-center text-center mt-4 pt-1">
                                <a id="login-fb-btn" class="text-white social-icon-facebook"><i class="fab fa-facebook-f fa-lg"></i></a>
                                <a id="google-google-btn" class="text-white social-icon-google mx-4"><i class="fab fa-google fa-lg"></i></a>
                            </div>
                        </div>
